...
-- Script date 1/24/2026 5:26:36 PM
...
--
-- Drop table `invoice_promotion`
--
DROP TABLE IF EXISTS invoice_promotion;
...
--
ALTER TABLE promotion
ADD CONSTRAINT promotion_ibfk_1 FOREIGN KEY (type_id)
...
--
ALTER TABLE restaurant_table
ADD CONSTRAINT FK_restaurant_table_table_type FOREIGN KEY (table_type)
REFERENCES setting_item (setting_id);
...
--
CREATE TABLE invoice_promotion (
  invoice_promotion_id bigint NOT NULL AUTO_INCREMENT,
  invoice_id bigint NOT NULL,
  promotion_id bigint NOT NULL,
  discount_amount decimal(14, 2) NOT NULL,
  applied_at datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (invoice_promotion_id)
)
ENGINE = INNODB,
CHARACTER SET utf8mb4,
COLLATE utf8mb4_unicode_ci,
...
--
-- Create index `idx_invoice_promo_invoice` on table `invoice_promotion`
--
ALTER TABLE invoice_promotion
ADD INDEX idx_invoice_promo_invoice (invoice_id);

--
-- Create index `idx_invoice_promo_promo` on table `invoice_promotion`
--
ALTER TABLE invoice_promotion
ADD INDEX idx_invoice_promo_promo (promotion_id);

--
-- Create index `uq_invoice_promo` on table `invoice_promotion`
--
ALTER TABLE invoice_promotion
ADD UNIQUE INDEX uq_invoice_promo (invoice_id, promotion_id);

--
-- Create foreign key
--
ALTER TABLE invoice_promotion
ADD CONSTRAINT invoice_promotion_ibfk_1 FOREIGN KEY (invoice_id)
REFERENCES invoice (invoice_id);
...
--
ALTER TABLE invoice_promotion
ADD CONSTRAINT invoice_promotion_ibfk_2 FOREIGN KEY (promotion_id)
REFERENCES promotion (promotion_id);
...
-- Table restaurant_mgmt.invoice_promotion does not contain any data (it is empty)
