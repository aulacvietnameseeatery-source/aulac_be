...
-- Script date 1/21/2026 6:32:25 PM
...
-- Table restaurant_mgmt.setting_category does not contain any data (it is empty)

-- Table restaurant_mgmt.setting_item does not contain any data (it is empty)

-- Table restaurant_mgmt.dish_category does not contain any data (it is empty)

-- Table restaurant_mgmt.role does not contain any data (it is empty)
...
-- Table restaurant_mgmt.account does not contain any data (it is empty)
...
-- Table restaurant_mgmt.permission does not contain any data (it is empty)
...
-- Table restaurant_mgmt.role_permission does not contain any data (it is empty)
...
-- Table restaurant_mgmt.auth_session does not contain any data (it is empty)
