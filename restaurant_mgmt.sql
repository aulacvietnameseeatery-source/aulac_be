...
-- Script date 1/31/2026 11:38:28 PM
...
CREATE TABLE staff_account (
  ...
  account_status int NOT NULL DEFAULT 1 COMMENT 'AccountStatus: 1=ACTIVE,2=INACTIVE,3=LOCKED',
...
--
INSERT INTO lookup_type(type_id, type_code, type_name, description, is_configurable, is_system) VALUES
(1, 'ACCOUNT_STATUS', 'Account Status', 'staff_account.account_status', 0, 1),
(2, 'INVENTORY_TX_TYPE', 'Inventory Transaction Type', 'inventory_transaction.type', 0, 1),
(3, 'INVENTORY_TX_STATUS', 'Inventory Transaction Status', 'inventory_transaction.status', 0, 1),
(4, 'MEDIA_TYPE', 'Media Type', 'media_asset.media_type_id', 1, 1),
(5, 'TABLE_STATUS', 'Table Status', 'restaurant_table.table_status', 0, 1),
(6, 'TABLE_TYPE', 'Table Type', 'restaurant_table.table_type', 1, 1),
(7, 'RESERVATION_SOURCE', 'Reservation Source', 'reservation.source_id', 1, 1),
(8, 'RESERVATION_STATUS', 'Reservation Status', 'reservation.reservation_status', 0, 1),
(9, 'ORDER_SOURCE', 'Order Source', 'orders.source_id', 1, 1),
(10, 'ORDER_STATUS', 'Order Status', 'orders.order_status', 0, 1),
(11, 'PAYMENT_METHOD', 'Payment Method', 'payment.method_id', 1, 1),
(12, 'DISH_STATUS', 'Dish Status', 'dish.dish_status', 0, 1),
(13, 'ORDER_ITEM_STATUS', 'Order Item Status', 'order_item.item_status', 0, 1),
(14, 'SEVERITY', 'Severity', 'service_error.severity_id', 1, 1),
(15, 'PROMOTION_TYPE', 'Promotion Type', 'promotion.type_id', 1, 1),
(16, 'PROMOTION_STATUS', 'Promotion Status', 'promotion.promotion_status', 0, 1),
(17, 'INGREDIENT_TYPE', 'Ingredient Type', 'ingredient.type', 1, 1);

-- 
-- Dumping data for table lookup_value
--
INSERT INTO lookup_value(value_id, type_id, value_code, value_name, sort_order, is_active, meta, is_system, locked, deleted_at) VALUES
(1, 1, 'ACTIVE', 'Active', 1, 1, '{"legacy_num": 1}', 1, 1, NULL),
(2, 1, 'INACTIVE', 'Inactive', 2, 1, '{"legacy_num": 2}', 1, 1, NULL),
(3, 1, 'LOCKED', 'Locked', 3, 1, '{"legacy_num": 3}', 1, 1, NULL),
(4, 2, 'IN', 'In', 1, 1, '{"legacy_num": 1}', 1, 1, NULL),
(5, 2, 'OUT', 'Out', 2, 1, '{"legacy_num": 2}', 1, 1, NULL),
(6, 2, 'ADJUST', 'Adjust', 3, 1, '{"legacy_num": 3}', 1, 1, NULL),
(7, 3, 'DRAFT', 'Draft', 1, 1, '{"legacy_num": 1}', 1, 1, NULL),
(8, 3, 'PENDING_APPROVAL', 'Pending approval', 2, 1, '{"legacy_num": 2}', 1, 1, NULL),
(9, 3, 'COMPLETED', 'Completed', 3, 1, '{"legacy_num": 3}', 1, 1, NULL),
(10, 3, 'CANCELLED', 'Cancelled', 4, 1, '{"legacy_num": 4}', 1, 1, NULL),
(14, 5, 'AVAILABLE', 'Available', 1, 1, '{"legacy_num": 1}', 1, 1, NULL),
(15, 5, 'OCCUPIED', 'Occupied', 2, 1, '{"legacy_num": 2}', 1, 1, NULL),
(16, 5, 'RESERVED', 'Reserved', 3, 1, '{"legacy_num": 3}', 1, 1, NULL),
(17, 5, 'LOCKED', 'Locked', 4, 1, '{"legacy_num": 4}', 1, 1, NULL),
(21, 8, 'PENDING', 'Pending', 1, 1, '{"legacy_num": 1}', 1, 1, NULL),
(22, 8, 'CONFIRMED', 'Confirmed', 2, 1, '{"legacy_num": 2}', 1, 1, NULL),
(23, 8, 'CHECKED_IN', 'Checked in', 3, 1, '{"legacy_num": 3}', 1, 1, NULL),
(24, 8, 'CANCELLED', 'Cancelled', 4, 1, '{"legacy_num": 4}', 1, 1, NULL),
(25, 8, 'NO_SHOW', 'No show', 5, 1, '{"legacy_num": 5}', 1, 1, NULL),
(28, 10, 'PENDING', 'Pending', 1, 1, '{"legacy_num": 1}', 1, 1, NULL),
(29, 10, 'IN_PROGRESS', 'In progress', 2, 1, '{"legacy_num": 2}', 1, 1, NULL),
(30, 10, 'COMPLETED', 'Completed', 3, 1, '{"legacy_num": 3}', 1, 1, NULL),
(31, 10, 'CANCELLED', 'Cancelled', 4, 1, '{"legacy_num": 4}', 1, 1, NULL),
(35, 13, 'CREATED', 'Created', 1, 1, '{"legacy_num": 1}', 1, 1, NULL),
(36, 13, 'IN_PROGRESS', 'In progress', 2, 1, '{"legacy_num": 2}', 1, 1, NULL),
(37, 13, 'READY', 'Ready', 3, 1, '{"legacy_num": 3}', 1, 1, NULL),
(38, 13, 'SERVED', 'Served', 4, 1, '{"legacy_num": 4}', 1, 1, NULL),
(39, 13, 'REJECTED', 'Rejected', 5, 1, '{"legacy_num": 5}', 1, 1, NULL),
(42, 12, 'AVAILABLE', 'Available', 1, 1, '{"legacy_num": 1}', 1, 1, NULL),
(43, 12, 'OUT_OF_STOCK', 'Out of stock', 2, 1, '{"legacy_num": 2}', 1, 1, NULL),
(44, 12, 'HIDDEN', 'Hidden', 3, 1, '{"legacy_num": 3}', 1, 1, NULL),
(45, 16, 'SCHEDULED', 'Scheduled', 1, 1, '{"legacy_num": 1}', 1, 1, NULL),
(46, 16, 'ACTIVE', 'Active', 2, 1, '{"legacy_num": 2}', 1, 1, NULL),
(47, 16, 'EXPIRED', 'Expired', 3, 1, '{"legacy_num": 3}', 1, 1, NULL),
(48, 16, 'DISABLED', 'Disabled', 4, 1, '{"legacy_num": 4}', 1, 1, NULL),
(52, 4, 'IMAGE', 'Image', 1, 1, '{"legacy_num": 1}', 1, 0, NULL),
(53, 4, 'VIDEO', 'Video', 2, 1, '{"legacy_num": 2}', 1, 0, NULL),
(55, 11, 'CASH', 'Cash', 1, 1, '{"legacy_num": 1}', 1, 0, NULL),
(56, 11, 'CARD', 'Card', 2, 1, '{"legacy_num": 2}', 1, 0, NULL),
(57, 11, 'QR', 'QR', 3, 1, '{"legacy_num": 3}', 1, 0, NULL),
(58, 9, 'DINE_IN', 'Dine-in', 1, 1, '{"legacy_num": 1}', 1, 0, NULL),
(59, 9, 'TAKEAWAY', 'Takeaway', 2, 1, '{"legacy_num": 2}', 1, 0, NULL),
(60, 9, 'DELIVERY', 'Delivery', 3, 1, '{"legacy_num": 3}', 1, 0, NULL),
(61, 7, 'PHONE', 'Phone', 1, 1, '{"legacy_num": 1}', 1, 0, NULL),
(62, 7, 'WALK_IN', 'Walk-in', 2, 1, '{"legacy_num": 2}', 1, 0, NULL),
(63, 7, 'ONLINE', 'Online', 3, 1, '{"legacy_num": 3}', 1, 0, NULL),
(64, 6, 'NORMAL', 'Normal', 1, 1, '{"legacy_num": 1}', 1, 0, NULL),
(65, 6, 'VIP', 'VIP', 2, 1, '{"legacy_num": 2}', 1, 0, NULL),
(66, 6, 'OUTDOOR', 'Outdoor', 3, 1, '{"legacy_num": 3}', 1, 0, NULL),
(67, 6, 'BOOTH', 'Booth', 4, 1, '{"legacy_num": 4}', 1, 0, NULL),
(71, 14, 'LOW', 'Low', 1, 1, '{"legacy_num": 1}', 1, 0, NULL),
(72, 14, 'MEDIUM', 'Medium', 2, 1, '{"legacy_num": 2}', 1, 0, NULL),
(73, 14, 'HIGH', 'High', 3, 1, '{"legacy_num": 3}', 1, 0, NULL),
(74, 14, 'CRITICAL', 'Critical', 4, 1, '{"legacy_num": 4}', 1, 0, NULL),
(78, 15, 'PERCENT', 'Percent', 1, 1, '{"legacy_num": 1}', 1, 0, NULL),
(79, 15, 'FIXED_AMOUNT', 'Fixed amount', 2, 1, '{"legacy_num": 2}', 1, 0, NULL),
(81, 17, 'RAW_MATERIAL', 'Raw material', 1, 1, '{"legacy_num": 1}', 1, 0, NULL),
(82, 17, 'SEMI_PROCESSED', 'Semi-processed', 2, 1, '{"legacy_num": 2}', 1, 0, NULL),
(83, 17, 'SEASONING', 'Seasoning', 3, 1, '{"legacy_num": 3}', 1, 0, NULL),
(84, 17, 'BEVERAGE', 'Beverage', 4, 1, '{"legacy_num": 4}', 1, 0, NULL),
(85, 17, 'PACKAGING', 'Packaging', 5, 1, '{"legacy_num": 5}', 1, 0, NULL);
...
--
INSERT INTO staff_account(account_id, full_name, phone, email, role_id, account_status, created_at, username, password_hash, is_locked, last_login_at, account_status_lv_id) VALUES
(1, 'dat', '0342164017', 'nguyenducdat0406@gmail.com', 2, 1, '2026-01-22 23:16:23', 'staff_test_acc', '$2a$12$fDKaNANYfD4wllHpbydiDeRQAuc/G1YYczuEU03/BXkdb/FUUvKRC', 0, '2026-01-31 14:41:24', 1),
(2, 'admin', '0999999999', 'admin@gmail.com', 1, 1, '2026-01-22 23:19:05', 'admin', '$2a$12$D2mHO0ctG2eHDA8kZ0JR5u6WmRkmaoMzNmjuwmIqFQfRRTlM2KbE2', 0, '2026-01-31 10:08:57', 1);
...
-- Table restaurant_mgmt.system_setting does not contain any data (it is empty)
