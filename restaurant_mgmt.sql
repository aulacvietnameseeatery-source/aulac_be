...
-- Script date 1/25/2026 1:36:13 AM
...
--
ALTER TABLE staff_account
ADD CONSTRAINT staff_account_ibfk_2 FOREIGN KEY (status_id)
REFERENCES setting_item (setting_id);
...
--
INSERT INTO staff_account(account_id, full_name, phone, email, role_id, status_id, created_at, username, password_hash, is_locked, last_login_at) VALUES
