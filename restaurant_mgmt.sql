...
-- Script date 2/2/2026 8:46:22 PM
...
--
INSERT INTO lookup_value(value_id, type_id, value_code, value_name, sort_order, is_active, meta, is_system, locked, deleted_at, description) VALUES
(1, 1, 'ACTIVE', 'Active', 1, 1, '{"legacy_num": 1}', 1, 1, NULL, NULL),
(2, 1, 'INACTIVE', 'Inactive', 2, 1, '{"legacy_num": 2}', 1, 1, NULL, NULL),
(3, 1, 'LOCKED', 'Locked', 3, 1, '{"legacy_num": 3}', 1, 1, NULL, NULL),
(4, 2, 'IN', 'In', 1, 1, '{"legacy_num": 1}', 1, 1, NULL, NULL),
(5, 2, 'OUT', 'Out', 2, 1, '{"legacy_num": 2}', 1, 1, NULL, NULL),
(6, 2, 'ADJUST', 'Adjust', 3, 1, '{"legacy_num": 3}', 1, 1, NULL, NULL),
(7, 3, 'DRAFT', 'Draft', 1, 1, '{"legacy_num": 1}', 1, 1, NULL, NULL),
(8, 3, 'PENDING_APPROVAL', 'Pending approval', 2, 1, '{"legacy_num": 2}', 1, 1, NULL, NULL),
(9, 3, 'COMPLETED', 'Completed', 3, 1, '{"legacy_num": 3}', 1, 1, NULL, NULL),
(10, 3, 'CANCELLED', 'Cancelled', 4, 1, '{"legacy_num": 4}', 1, 1, NULL, NULL),
(14, 5, 'AVAILABLE', 'Available', 1, 1, '{"legacy_num": 1}', 1, 1, NULL, NULL),
(15, 5, 'OCCUPIED', 'Occupied', 2, 1, '{"legacy_num": 2}', 1, 1, NULL, NULL),
(16, 5, 'RESERVED', 'Reserved', 3, 1, '{"legacy_num": 3}', 1, 1, NULL, NULL),
(17, 5, 'LOCKED', 'Locked', 4, 1, '{"legacy_num": 4}', 1, 1, NULL, NULL),
(21, 8, 'PENDING', 'Pending', 1, 1, '{"legacy_num": 1}', 1, 1, NULL, NULL),
(22, 8, 'CONFIRMED', 'Confirmed', 2, 1, '{"legacy_num": 2}', 1, 1, NULL, NULL),
(23, 8, 'CHECKED_IN', 'Checked in', 3, 1, '{"legacy_num": 3}', 1, 1, NULL, NULL),
(24, 8, 'CANCELLED', 'Cancelled', 4, 1, '{"legacy_num": 4}', 1, 1, NULL, NULL),
(25, 8, 'NO_SHOW', 'No show', 5, 1, '{"legacy_num": 5}', 1, 1, NULL, NULL),
(28, 10, 'PENDING', 'Pending', 1, 1, '{"legacy_num": 1}', 1, 1, NULL, NULL),
(29, 10, 'IN_PROGRESS', 'In progress', 2, 1, '{"legacy_num": 2}', 1, 1, NULL, NULL),
(30, 10, 'COMPLETED', 'Completed', 3, 1, '{"legacy_num": 3}', 1, 1, NULL, NULL),
(31, 10, 'CANCELLED', 'Cancelled', 4, 1, '{"legacy_num": 4}', 1, 1, NULL, NULL),
(35, 13, 'CREATED', 'Created', 1, 1, '{"legacy_num": 1}', 1, 1, NULL, NULL),
(36, 13, 'IN_PROGRESS', 'In progress', 2, 1, '{"legacy_num": 2}', 1, 1, NULL, NULL),
(37, 13, 'READY', 'Ready', 3, 1, '{"legacy_num": 3}', 1, 1, NULL, NULL),
(38, 13, 'SERVED', 'Served', 4, 1, '{"legacy_num": 4}', 1, 1, NULL, NULL),
(39, 13, 'REJECTED', 'Rejected', 5, 1, '{"legacy_num": 5}', 1, 1, NULL, NULL),
(42, 12, 'AVAILABLE', 'Available', 1, 1, '{"legacy_num": 1}', 1, 1, NULL, NULL),
(43, 12, 'OUT_OF_STOCK', 'Out of stock', 2, 1, '{"legacy_num": 2}', 1, 1, NULL, NULL),
(44, 12, 'HIDDEN', 'Hidden', 3, 1, '{"legacy_num": 3}', 1, 1, NULL, NULL),
(45, 16, 'SCHEDULED', 'Scheduled', 1, 1, '{"legacy_num": 1}', 1, 1, NULL, NULL),
(46, 16, 'ACTIVE', 'Active', 2, 1, '{"legacy_num": 2}', 1, 1, NULL, NULL),
(47, 16, 'EXPIRED', 'Expired', 3, 1, '{"legacy_num": 3}', 1, 1, NULL, NULL),
(48, 16, 'DISABLED', 'Disabled', 4, 1, '{"legacy_num": 4}', 1, 1, NULL, NULL),
(52, 4, 'IMAGE', 'Image', 1, 1, '{"legacy_num": 1}', 1, 0, NULL, NULL),
(53, 4, 'VIDEO', 'Video', 2, 1, '{"legacy_num": 2}', 1, 0, NULL, NULL),
(55, 11, 'CASH', 'Cash', 1, 1, '{"legacy_num": 1}', 1, 0, NULL, NULL),
(56, 11, 'CARD', 'Card', 2, 1, '{"legacy_num": 2}', 1, 0, NULL, NULL),
(57, 11, 'QR', 'QR', 3, 1, '{"legacy_num": 3}', 1, 0, NULL, NULL),
(58, 9, 'DINE_IN', 'Dine-in', 1, 1, '{"legacy_num": 1}', 1, 0, NULL, NULL),
(59, 9, 'TAKEAWAY', 'Takeaway', 2, 1, '{"legacy_num": 2}', 1, 0, NULL, NULL),
(60, 9, 'DELIVERY', 'Delivery', 3, 1, '{"legacy_num": 3}', 1, 0, NULL, NULL),
(61, 7, 'PHONE', 'Phone', 1, 1, '{"legacy_num": 1}', 1, 0, NULL, NULL),
(62, 7, 'WALK_IN', 'Walk-in', 2, 1, '{"legacy_num": 2}', 1, 0, NULL, NULL),
(63, 7, 'ONLINE', 'Online', 3, 1, '{"legacy_num": 3}', 1, 0, NULL, NULL),
(64, 6, 'NORMAL', 'Normal', 1, 1, '{"legacy_num": 1}', 1, 0, NULL, NULL),
(65, 6, 'VIP', 'VIP', 2, 1, '{"legacy_num": 2}', 1, 0, NULL, NULL),
(66, 6, 'OUTDOOR', 'Outdoor', 3, 1, '{"legacy_num": 3}', 1, 0, NULL, NULL),
(67, 6, 'BOOTH', 'Booth', 4, 1, '{"legacy_num": 4}', 1, 0, NULL, NULL),
(71, 14, 'LOW', 'Low', 1, 1, '{"legacy_num": 1}', 1, 0, NULL, NULL),
(72, 14, 'MEDIUM', 'Medium', 2, 1, '{"legacy_num": 2}', 1, 0, NULL, NULL),
(73, 14, 'HIGH', 'High', 3, 1, '{"legacy_num": 3}', 1, 0, NULL, NULL),
(74, 14, 'CRITICAL', 'Critical', 4, 1, '{"legacy_num": 4}', 1, 0, NULL, NULL),
(78, 15, 'PERCENT', 'Percent', 1, 1, '{"legacy_num": 1}', 1, 0, NULL, NULL),
(79, 15, 'FIXED_AMOUNT', 'Fixed amount', 2, 1, '{"legacy_num": 2}', 1, 0, NULL, NULL),
(81, 17, 'RAW_MATERIAL', 'Raw material', 1, 1, '{"legacy_num": 1}', 1, 0, NULL, NULL),
(82, 17, 'SEMI_PROCESSED', 'Semi-processed', 2, 1, '{"legacy_num": 2}', 1, 0, NULL, NULL),
(83, 17, 'SEASONING', 'Seasoning', 3, 1, '{"legacy_num": 3}', 1, 0, NULL, NULL),
(84, 17, 'BEVERAGE', 'Beverage', 4, 1, '{"legacy_num": 4}', 1, 0, NULL, NULL),
(85, 17, 'PACKAGING', 'Packaging', 5, 1, '{"legacy_num": 5}', 1, 0, NULL, NULL);
